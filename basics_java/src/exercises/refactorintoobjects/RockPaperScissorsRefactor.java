...
class RockPaperScissors {
    ...
    private static void generateScoreSheet(int computerWinCount, int userWinCount, int tieCount) {
        ...
        System.out.println("Computer won: " + computerWinCount);
        System.out.println("You won: " + userWinCount);
        System.out.println("Ties: " + tieCount);
        String message = computerWinCount > userWinCount ? "Computer wins!" : userWinCount > computerWinCount ? "You win!" : "It's a draw!";
